function AnswerButton({
  ...
  if (selectedAnswer === letter) {
    buttonBackgroundClass =
      "bg-gradient-to-r from-amber-800 via-yellow-500 to-amber-800";
  ...
  if (correctAnswer === letter) {
    buttonBackgroundClass =
      "bg-gradient-to-r from-green-900 via-green-400 to-green-900 animate-pulse";
  ...
  return (
    ...
    >
      <div
        className={
          "flex justify-start items-center h-full w-full rounded-xl p-2 pl-6 text-3xl " +
          buttonBackgroundClass
        }
      >
